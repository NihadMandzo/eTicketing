...
public interface IUserInteractionRepository : IRepository<UserInteraction, Guid>
{
    ...
    /// service method owns the single SaveChangesAsync, per .claude/rules/10-backend.md.</summary>
    ...
    /// the "Popularno u vašem gradu" fallback, and the tail-padding of every other path.</summary>
