...
public static class ProductEndpoints
{
    public static void MapProductEndpoints(this WebApplication app)
    {
        ...
        group.MapGet("/organization-ids", GetOrganizationIds).RequireAuthorization("PlatformStaff")
            .WithValidation<ProductOrganizationIdsQuery>();
    ...
    private static async Task<IResult> GetOrganizationIds(
        [AsParameters] ProductOrganizationIdsQuery query, IProductService service, CancellationToken ct)
    {
        var result = await service.GetOrganizationIdsAsync(query.ParsedCategoryIds, ct);
        return result.ToHttpResult();
    }
