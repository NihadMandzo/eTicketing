...
///
/// Ticketing itself never uploads — it only calls GetPublicUrl to turn Ticket.PdfBlobName into a
/// download link — so for this service's tests the URL-shaping half is the part that matters.
/// </summary>
