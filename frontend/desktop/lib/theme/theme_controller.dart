...
/// App-wide light/dark preference, persisted locally to this machine only
/// (this app's own `shared_preferences` store — independent of the web and
/// mobile apps' preferences). Mirrors the `ValueNotifier`-based state
/// pattern already used by `Session` in the mobile app rather than pulling
